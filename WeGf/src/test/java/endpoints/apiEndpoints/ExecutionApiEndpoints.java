...
public final class ExecutionApiEndpoints {
    ...
    public static final HttpRequestActionBuilder chargerExerciceComptable =
            http("Charger exercice comptable")
    ...
    public static final HttpRequestActionBuilder fournirListeSerieBordereaux = 
        http("Fournir liste serie bordereaux")
            ...
            .body(StringBody("{\"exercice\":25,\"sens\":{\"_id\":3,\"_lib\":\"Recette\",\"@id\":2,\"@type\":\"TypeGestionSens\"},\"annulatif\":false,\"defaut\":null,\"elementsACharger\":null}"))
            .headers(ApiHeaders.bearerWithTenant("content-type", "application/json"))
            .check(jmesPath("donnees[0].id").ofInt().gt(0));

    public static final HttpRequestActionBuilder chargerFields = 
    http("Charger fields")
        ...
        .body(StringBody("{\"classePersistante\":\"ExerciceComptable\",\"id\":25,\"elementACharger\":[\"budgetRef.collectiviteRef\",\"normeComptableRef\"]}"))
        .headers(ApiHeaders.bearerWithTenant("content-type", "application/json"))
        .check(jmesPath("budgetRef.id").ofInt().gt(0));

    public static final HttpRequestActionBuilder chargerTailleLimite = 
    http("Charger taille limite")
        .post("https://wegf-api.uat.wemagnus.com/compta/Ordonnancement/chargerTailleLimitePES?fieldNames%5B%5D=**")
        .headers(ApiHeaders.bearerWithTenant("content-type", "application/json"))
        .check(bodyLength().gt(0));


        public static final HttpRequestActionBuilder liquidationsTitre =
        http("Liquidations titre")
        ...
        public static final HttpRequestActionBuilder liquidationsMandat =
        http("Liquidations titre")
                .get("https://wegf-api.uat.wemagnus.com/compta/liquidations")
                .queryParam("fields[liquidations]", LIQUIDATIONS_FIELDS)
                .queryParam("filter[exerciceComptableId]", "#{userContextCBE.exercice.exercice.id}")
                ...
                public static final HttpRequestActionBuilder gestionFonctionsEtAxesAnalytiques =
                http("Gestion fonctions et axes analytiques")
                ...
                public static final HttpRequestActionBuilder chargerListe =
                http("Charger liste")
